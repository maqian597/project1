...
public class Item {
	//can add final means never be changed
	...
	//need constructer. but has about 18 fields; can use builder pattern.
	//
	/**
	...
	//why public ? itermbuilder need to create object, so public, 
	//but actually the constructer only itermbuilder use, so it's private
	//why static ? non-static need instance to call, but itermbuilder is to instance the object, this is dead loop, so need static;
